        ...
        <section class="alternativas">
            <form action="">
                <label for="alternativa_a">
                    <input type="radio" id="alternativa_a" name="aleternativa" value="${alterarSinais(quiz.questions[pergunta-1].options[0])}">
                ...
                <label for="alternativa_b">
                    <input type="radio" id="alternativa_b" name="aleternativa" value="${alterarSinais(quiz.questions[pergunta-1].options[1])}">
                ...
                <label for="alternativa_c">
                    <input type="radio" id="alternativa_c" name="aleternativa" value="${alterarSinais(quiz.questions[pergunta-1].options[2])}">
                ...
                <label for="alternativa_d">
                    <input type="radio" id="alternativa_d" name="aleternativa" value="${alterarSinais(quiz.questions[pergunta-1].options[3])}">
